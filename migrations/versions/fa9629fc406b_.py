...
def seed_data():
    # Fill the db with dummy data and adjust the sequence ids
    ...
    op.get_bind().execute("ALTER SEQUENCE venues_id_seq RESTART WITH 4;")
    op.get_bind().execute("ALTER SEQUENCE artists_id_seq RESTART WITH 7;")
    op.get_bind().execute("ALTER SEQUENCE shows_id_seq RESTART WITH 6;")
